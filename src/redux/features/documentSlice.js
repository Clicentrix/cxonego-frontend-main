...
export const checkGoogleConnection = createAsyncThunk("documents/checkGoogleConnection", async () => {
    try {
...
// Get Google Auth URL
export const getGoogleAuth = createAsyncThunk("documents/getGoogleAuth", async () => {
    try {
...
export const getGoogleReconnect = createAsyncThunk("documents/getGoogleReconnect", async () => {
    try {
...
export const disconnectGoogle = createAsyncThunk("documents/disconnectGoogle", async (_, { dispatch }) => {
    try {
...
// Upload document
export const uploadDocumentThunk = createAsyncThunk("documents/uploadDocument", async (payload, { rejectWithValue }) => {
...
export const { resetDocument, resetDocuments, setEditableMode, handleInputChangeReducerDocument, } = documentSlice.actions;
